<title><?php echo $website_details[0]->title?> || Services || Consulting Services || <?php echo  $service_info[0]->title ?> </title>
                        ...
                        <div class="col-12 mx-auto inner">
                            ...
                            <nav data-aos="zoom-out-up" data-aos-delay="800" aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item " aria-current="page"><a href="<?php echo $properties['baseurl']; ?>services-offered">Services</a></li>
                                    <li class="breadcrumb-item active" aria-current="page"><?php echo  $service_info[0]->title ?></li>
                                </ol>
                            </nav>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-8 p-0 text">
                    <div class="row intro m-0">
                        <div class="col-12">
                            <span class="pre-title m-0">Service Infomation</span>
                            <div class="title-icon">
                                <h2><?php echo  $service_info[0]->title ?></h2>
                            </div>
                        </div>
                    </div>
                    <div class="row ">
                        <div class="col-12 col-md-12">
                                <img src="<?php echo $service_info[0]->thumbnail; ?>" alt="<?php echo  $service_info[0]->title ?>">
                            </div>
                            ...
                            <div class="quote">
                                <ul class="list-group list-group-flush">
                                    ...
                                    <?php 
                                        ...
                                        if ( !empty( $innovare->getActiveServicesLimit($service_info[0]->id) ) ) {
                                            
                                            foreach ($innovare->getActiveServicesLimit($service_info[0]->id) as $services_info ) {
                                                // var_dump($team_info);die();
                                    ?> 

                                        <li class="list-group-item d-flex justify-content-start align-items-center">
                                            <a href="<?php echo $properties['baseurl']?>services-offered/<?php echo  $services_info->slug ?>">

                                            <div class="row row-eq-height">
                                                <div class="col-md-5" >
                                                    <img src="<?php echo $services_info->thumbnail ?>" style="width: 100%; height: 100px;">
                                                </div>
                                                <div class="col-md-7">
                                                    <div class="list-group-content">
                                                        <h6 class="title mb-0" style=""><?php echo  $services_info->title ?></h6>
                                                        <p>View</p>
                                                    </div>
