<title><?php echo $website_details[0]->title?> || What we do || Services </title>
        ...
        <div class="overflow-holder">
            <div class="container">
                ...
                ?>                      
                    <div class="col-12 col-md-6 col-lg-4 item filter-item" data-groups='["innovation","social","technology"]'>
                        <div class="row card p-0 text-center">
                            ...
                            <a href="<?php echo $properties['baseurl']; ?>services-offered/<?php echo $services_info->slug; ?>"><i class="btn-icon fas fas fa-arrow-right"></i></a>
                        </div>
                ...
                <?php } }else{ ?>
                    ...
                    <h3 class="text-center">NO SERVICE TO DISPLAY</h3>
