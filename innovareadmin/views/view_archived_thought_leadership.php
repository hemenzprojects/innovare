<title><?php echo $properties['title']; ?> || View Archived Thought Leadership</title>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title" id="hidden-label-basic-form">View Archived Thought Leadership</h4>
                        ...
                        <div class="card-content collpase show">
                            <div class="card-body">
                                ...
                                <table id="eventTableActive" class="table table-reponsive table-striped display nowrap row-border table-hover thead-dark" style="width: 100% !important;">
                                    ...
                                    <tbody>
                                        <?php foreach ($innovare->getArchivedThoughtLeaderships() as $leadership_info): 
                                                // var_dump($event_info);
                                            ?>
                                                ...
                                                <td style="text-align: center;">
                                                    ...
                                                    <div class="tool-container tool-bottom toolbar-dark  option" style="">
                                                        <div class="tool-items">
                                                            ...
                                                            <a href="?activate&leadership_id=<?php echo $leadership_info->id ?>" title="Archive" class="tool-item">
