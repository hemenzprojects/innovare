<title><?php echo $properties['title']; ?> || View Instructors Team</title>
        ...
        <div class="content-body">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title" id="hidden-label-basic-form">View Instructors Team (Ative)</h4>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title" id="hidden-label-basic-form">View Instructors Team (Archived)</h4>
                            <a class="heading-elements-toggle"><i class="fa fa-ellipsis-v font-medium-3"></i></a>
                            <div class="heading-elements">
                                <ul class="list-inline mb-0">
                                    <li><a data-action="collapse"><i class="ft-minus"></i></a></li>
                        ...
                        <div class="card-content collpase show">
                            <div class="card-body">
                                ...
                                <div id="simple-user-cards-with-border" class="row mt-2">
                                    <?php foreach ($innovare->getArchivedInstructor() as $team_info): 
