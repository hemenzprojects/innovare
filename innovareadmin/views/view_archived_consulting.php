<title><?php echo $properties['title']; ?> || View Archived Consulting Services</title>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title" id="hidden-label-basic-form">View Archived Consulting Services</h4>
                        ...
                        <div class="card-content collpase show">
                            <div class="card-body">
                                ...
                                <table id="eventTableActive" class="table table-reponsive table-striped display nowrap row-border table-hover thead-dark" style="width: 100% !important;">
                                    ...
                                    <tbody>
                                        <?php foreach ($innovare->getArchivedConsultingServices() as $services_info): 
                                                // var_dump($event_info);
                                            ?>
                                                ...
                                                <td style="text-align: center;">
                                                    ...
                                                    <div class="tool-container tool-bottom toolbar-dark  option" style="">
                                                        <div class="tool-items">
                                                            ...
                                                            <a href="<?php echo $properties['baseurl']?>view-consulting-service-details/<?php echo $services_info->id?>" title="View" class="tool-item">
                                                                <i class="fas fa-eye" aria-hidden="true"></i>
                                                            </a>

                                                            <a href="?activate&consulting_id=<?php echo $services_info->id ?>" title="Activate" class="tool-item">
                                                                <i class="fas fa-check-circle" aria-hidden="true"></i>
                                                            </a>

                                                            <a href="?delete&consulting_id=<?php echo $services_info->id ?>" title="Delete" class="tool-item">
