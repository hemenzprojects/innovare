<title><?php echo $properties['title']; ?> || Event Documents</title>
        ...
        <div class="content-body">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title" id="hidden-label-basic-form">Add Event Document(s)</h4>
                        ...
                        <div class="card-content collpase show">
                            <div class="card-body">
                                ...
                                <!-- <form class="form" id="add_course_doument" action="" method="POST" enctype="multipart/form-data"> -->
                                    <div class="form-body">
                                        <h4 class="form-section"><i class="fas fa-file-upload"></i> Event Document(s)</h4>
                                        <div class="row">
                                            <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title" id="hidden-label-basic-form"><?php echo $event_info[0]->title?> -- Event Documents</h4>
                            <a class="heading-elements-toggle"><i class="fa fa-ellipsis-v font-medium-3"></i></a>
                            <div class="heading-elements">
                                <ul class="list-inline mb-0">
                                    <li><a data-action="collapse"><i class="ft-minus"></i></a></li>
                        ...
                        <div class="card-content collpase show">
                            ...
                            <table id="adminTableActive" class="table table-reponsive table-striped display row-border table-hover thead-dark" style="width: 100% !important;">
                                ...
                                <tbody>
                                    <?php foreach ($innovare->getEventDoc($event_id) as $event_doc): 
                                            // var_dump($course_info);
                                        ?>
                                        <tr style="padding-top: 20px;">
                                            <td class="capital"><?php echo $event_doc->doc_id ?></td>
                                            ...
                                            <td class="capital" style="max-width:250px !important; ">
                                                ...
                                                <p><span style="font-weight: 600;">Name: </span><?php echo $event_doc->name; ?></p>

                                                <p><span style="font-weight: 600;">Extension: </span>.<?php echo $event_doc->extension; ?></p>

                                                <p><span style="font-weight: 600;">URL: </span><a href="<?php echo $event_doc->url; ?>" target="_blank" style="color:#E93F33" >Document Link</a></p>

                                            </td>

                                            <td class="capital"><?php echo date('jS F, Y', strtotime($event_doc->created_at)) ?></td>


                                            <!-- <td class="capital" style="">

                                                <?php //if ($event_doc->status == 'active') { ?>
                                                ...
                                                <?php// } //else if ($event_doc->status == 'Deleted') { ?>
                                            ...
                                            <td style="text-align: center;">
                                                ...
                                                <div class="tool-container tool-bottom toolbar-dark  option" style="">
                                                    <div class="tool-items">
                                                        <a href="?doc_delete&doc_id=<?php echo $event_doc->doc_id ?>" title="Delete" class="tool-item">
