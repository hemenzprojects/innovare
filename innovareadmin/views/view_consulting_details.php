<title><?php echo $properties['title']; ?> || View Consulting Service Details</title>
	        	...
	        	<div class="content-body">
		                ...
		                <div class="col-md-12">
		                    <div class="card">
		                    	<div class="card-head">
			                        <div class="card-header">
			                           <h4 class="card-title" style="text-transform: uppercase;">Consulting Service Details</h4>
			                           <!-- <a class="heading-elements-toggle"><i class="fa fa-ellipsis-v font-medium-3"></i></a> -->
			                           <div class="heading-elements">
				                            <div class="btn-group " role="group" >
					                           	<a class="btn  btn-dark" href="<?php echo $properties['baseurl']?>edit-consulting-service-details/<?php echo $service_info[0]->id?>" style="padding: 10px;border-right: 2px solid #ffffff6e;">
					                           		<i class="fas fa-edit"></i> Edit
					                           	</a>
					                           	<?php if ($service_info[0]->status == 'active') : ?>
						                           	<a class="btn btn-dark" href="?archive&service_id=<?php echo $service_info[0]->id ?>" style="padding: 10px;border-right: 2px solid #ffffff6e;">
						                           		<i class="fas fa-archive"></i> Archive
						                           	</a>	
						                        <?php elseif ($service_info[0]->status == 'archived') : ?>
						                           	<a class="btn btn-dark" href="?activate&service_id=<?php echo $service_info[0]->id ?>" style="padding: 10px;border-right: 2px solid #ffffff6e;">
		                    ...
		                    <div id="project-info" class="card-body row">
		                        <div class="col-lg-12 col-md-12" style="">
		                           <img src="<?php echo $service_info[0]->thumbnail; ?>" style="width: 100%;" >
		                        </div>
		                        <div class="col-md-12">
		                        	<div class="course-title">
		                        		<h2>Title: <span style="font-weight: 500"><?php echo $service_info[0]->title; ?></span></h2>
		            ...
		            <div class="row">
		                <div class="col-md-12">
		                    <div class="card">
		                        <div class="card-header">
		                            <h4 class="card-title" id="hidden-label-basic-form">Consulting Service Description</h4>
		                            <a class="heading-elements-toggle"><i class="fa fa-ellipsis-v font-medium-3"></i></a>
		                            <div class="heading-elements">
	        ...
	        <div class="sidebar-detached sidebar-right">
	          	<div class="sidebar">
		            <div class="project-sidebar-content">
		               <div class="card">
		                  	<div class="card-header">
		                        <h4 class="card-title" id="hidden-label-basic-form">Consulting Service Status</h4>
		                        <a class="heading-elements-toggle"><i class="fa fa-ellipsis-v font-medium-3"></i></a>
		                        <div class="heading-elements">
		                            <ul class="list-inline mb-0">
		                                <li><a data-action="collapse"><i class="ft-minus"></i></a></li>
		                          	...
		                          	<div class="row" style="text-align: center;">
		                          		<div class="col-md-12">
		                          			...
		                          			<p>STATUS:<br><br>
		                          				...
		                          				<p>DATE CREATED:<br>
		                          					<p><?php echo date('jS F, Y', strtotime($service_info[0]->created_at));?> </p>
		                          			</p>
		                          		</div>	
		                          	</div>
		                      	</div>
