<title><?php echo $properties['title']; ?> || View Staff Team</title>
        ...
        <div class="content-body">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title" id="hidden-label-basic-form">View Staff Team (Ative)</h4>
                        ...
                        <div class="card-content collpase show">
                            <div class="card-body">
                                ...
                                <div id="simple-user-cards-with-border" class="row mt-2">
                                    <?php foreach ($innovare->getActiveStaff() as $team_info): 
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title" id="hidden-label-basic-form">View Staff Team (Archived)</h4>
                            <a class="heading-elements-toggle"><i class="fa fa-ellipsis-v font-medium-3"></i></a>
                            <div class="heading-elements">
                                <ul class="list-inline mb-0">
                                    <li><a data-action="collapse"><i class="ft-minus"></i></a></li>
                        ...
                        <div class="card-content collpase show">
                            <div class="card-body">
                                ...
                                <div id="simple-user-cards-with-border" class="row mt-2">
                                    <?php foreach ($innovare->getArchivedStaff() as $team_info): 
                                            // var_dump($course_info);
                                        ?>
                                        <div class="col-xl-3 col-md-6 col-12">
                                            <div class="card border-success border-lighten-3" style="box-shadow: 0 2px 1px rgb(0 0 0 / 5%)!important;">
