<title><?php echo $properties['title']; ?> || View Archived Case Studies</title>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title" id="hidden-label-basic-form">View Archived Case Studies</h4>
                            ...
                            <div class="card-body">
                                ...
                                <table id="eventTableActive" class="table table-reponsive table-striped display row-border table-hover thead-dark" style="width: 100% !important;">
                                    ...
                                    <tbody>
                                        <?php 
                                        $num = 1;
                                        foreach ($innovare->getArchivedCaseStudy() as $caseStudy_info): 
                                                ...
                                                <td style="text-align: center;">
                                                    ...
                                                    <div class="tool-container tool-bottom toolbar-dark  option" style="">
                                                        <div class="tool-items">
                                                            ...
                                                            <a href="?activate&caseStudy_id=<?php echo $caseStudy_info->id ?>" title="Archive" class="tool-item">
