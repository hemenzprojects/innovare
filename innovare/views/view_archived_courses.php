<title><?php echo $properties['title']; ?> || Archived Course</title>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title" id="hidden-label-basic-form">View Archived Courses</h4>
                        ...
                        <div class="card-content collpase show">
                            ...
                            <table id="adminTableActive" class="table table-reponsive table-striped display nowrap row-border table-hover thead-dark" style="width: 100% !important;">
                                <thead>
                                    <tr>
                                        <th></th>
                                        <th>Thumbnail</th>
                                ...
                                <tbody>
                                    <?php foreach ($innovare->getArchivedCourse() as $course_info): 
                                        ...
                                        <tr style="padding-top: 20px;">
                                            ...
                                            <td class="capital"><?php echo $properties['currency']?></span><span style="font-size: 13px;"> <?php echo number_format($course_info->price,2); ?></td>
                                            ...
                                            <td style="text-align: center;">
                                                ...
                                                <div class="tool-container tool-bottom toolbar-dark  option" style="">
                                                    <div class="tool-items">
                                                        ...
                                                        <a href="?activate&course_id=<?php echo $course_info->course_id ?>" title="Activate" class="tool-item">
