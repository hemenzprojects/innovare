                                        ...
                                        foreach ($innovare->getActiveEvent() as $event_info): 
                                            ...
                                            <tr style="padding-top: 20px;">
                                                ...
                                                <td class="capital">
                                                    ...
                                                    <p><a href="<?php echo $event_info->google_location; ?>" target="_blank" style="font-weight: 400;">Google Location </a></p>
                                                ...
                                                <?php if ($event_info->duration == 'one_day') { ?>
                                                    ...
                                                    <td class="capital">
                                                        ...
                                                        <p>
                                                            ...
                                                            <span style="font-weight: 600;">Time (From): </span><?php  echo  date("h:i:sa", strtotime($event_info->time_from)); ?>

                                                        </p>

                                                        <p>
                                                            <span style="font-weight: 600;">Time (To): </span><?php  echo  date("h:i:sa", strtotime($event_info->time_to)); ?>
                                                ...
                                                <td style="text-align: center;">
                                                    ...
                                                    <div class="tool-container tool-bottom toolbar-dark  option" style="">
                                                        <div class="tool-items">
                                                            ...
                                                            <a href="?archive&event_id=<?php echo $event_info->event_id ?>" title="Archive" class="tool-item">
