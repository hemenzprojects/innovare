                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title" id="hidden-label-basic-form">View Newsletter Subscriptions</h4>
                                    ...
                                    <tbody>
                                        <?php foreach ($innovare->getSubscription() as $subs_info): 
                                            ...
                                            <tr style="padding-top: 20px;">
                                                ...
                                                <td class="capital"><p><?php echo $subs_info->full_name; ?></p></td>

                                                <td class="capital"><p><?php echo $subs_info->email; ?></p></td>
