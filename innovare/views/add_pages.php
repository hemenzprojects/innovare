<title><?php echo $properties['title']; ?> || Add Pages</title>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="hidden-label-basic-form">Add Page</h4>
                    ...
                    <div class="card-content collpase show">
                        <div class="card-body">
                            ...
                            <form class="form" id="add_page_form" action="" method="POST" enctype="multipart/form-data">
                                <div class="form-body">
                                    <h4 class="form-section"><i class="fas fa-copy"></i> Page Info</h4>
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-12 mb-2">
                                            <label class="" for="projectinput1">Page Title</label>
                                    ...
                                    <!-- <h4 class="form-section"><i class="fas fa-info-circle"></i> Event Description</h4> -->
                                     ...
                                     <div class="row">
                                        ...
                                        <div class="form-group col-md-12 mb-2">
                                            <label class="" for="projectinput4">Page Description:</label>
                                ...
                                <div class="form-actions ">
                                    <button type="submit" id="add_page" name="add_page" class="btn btn-success btn-block btn-lg" style="padding-right: 60px;padding-left: 60px; ">Submit</button>
                                </div>
                            </form>
                        </div>
                    </div>
