          ...
          <ul class="nav navbar-nav flex-row">
            ...
            <li class="nav-item">
              <a class="navbar-brand" href="<?php echo $properties['baseurl']?>">
                <img class="brand-logo" alt="Innovare logo" src="<?php echo $properties['staticurl']?>app-assets/images/logo/logo.png">
                <!-- <h4 class="brand-text ">Innova</h4> -->
              </a>
            </li>
              ...
              <li class="dropdown dropdown-user nav-item">
                <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                  <span class="avatar avatar-online">
                    <img src="<?php echo $properties['staticurl']?>app-assets/images/portrait/medium/avatar-2.png" alt="avatar"><i></i>
                  </span>
                  <span class="user-name"><?php echo $name;?></span>
                </a>
                <div class="dropdown-menu dropdown-menu-right">
                  <a class="dropdown-item" href="<?php echo $properties['baseurl']?>edit-admin/<?php echo $admin_id;?>"><i class="ft-user"></i> Edit Profile</a>
                  <a class="dropdown-item" href="<?php echo $properties['baseurl']?>#"><i class="ft-mail"></i> My Inbox</a>
                  <!-- <a class="dropdown-item" href="email-application.html"><i class="ft-mail"></i> Change Password</a> -->
                  <div class="dropdown-divider"></div>
                  <a class="dropdown-item" href="<?php echo $properties['baseurl']?>logout"><i class="ft-power"></i> Logout</a>
                </div>
              </li>
            </ul>
          </div>
