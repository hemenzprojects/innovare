<script type="text/javascript">
	...
	$('#add_news_cat').on('submit', function(e){
        e.preventDefault();
        var name = $('#name').val();
        ...
        // console.log(name);
            ...
            $.ajax({
                type:'POST',
                url:`<?php echo $properties['baseurl']?>controller/newsController.php?add_cat`,
                data:{name,admin_id},
    ...
    $('#edit_news_cat').on('submit', function(e){
        e.preventDefault();
        var name = $('#name').val();
        var admin_id = $('#admin_id').val();
        ...
        // console.log(name,course_cat_id);
            ...
            $.ajax({
                type:'POST',
                url:`<?php echo $properties['baseurl']?>controller/newsController.php?edit_news_cat`,
                data:{name,news_cat_id,admin_id},
                success:function(response){
                    console.log(response);
                    var resp = JSON.parse(response);
                    console.log(resp.message);
