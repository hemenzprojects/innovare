<script type="text/javascript">
  // Get the template HTML and remove it from the doumenthe template HTML and remove it from the doument
    ...
    var myDropzone = new Dropzone("div#drop", { // Make the whole body a dropzone
      url: '<?php echo $properties['baseurl']?>controller/caseStudyDocumentController.php?caseStudy_id=<?php echo $_GET['caseStudy_id']?>', // Set the url
      thumbnailWidth: 80,
      thumbnailHeight: 60,
      parallelUploads: 40,
